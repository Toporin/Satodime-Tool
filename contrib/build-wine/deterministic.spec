...
print('Datas= '+repr([(home+'seedkeeper/*.png', '.')]) )
datas = [
	(home+'seedkeeper/*.png', '.'),
	(home+'seedkeeper/wordlist/*.txt', '.'),
...
exe_standalone = EXE(
    ...
    strip=None,
    upx=False,
    icon=home+'seedkeeper/satochip.ico', #home+'satochip_bridge/gui/icons/electrum.ico', #home+'electrum/gui/icons/electrum.ico',
    console=True)
